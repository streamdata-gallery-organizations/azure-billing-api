...
x-complete: 0
info:
  title: Azure Billing API Operations List
...
paths:
  ...
  /subscriptions/{subscriptionId}/providers/Microsoft.Billing/invoices/latest:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidprovidersmicrosoftbillinginvoiceslatest-get
      parameters:
      - in: query
        name: No Name
      responses:
  ...
  /providers/Microsoft.Billing/operations:
    get:
      ...
      x-api-path-slug: providersmicrosoftbillingoperations-get
      parameters:
      - in: query
        name: No Name
      responses:
  ...
  /{scope}/providers/Microsoft.Consumption/usageDetails:
    get:
      ...
      x-api-path-slug: scopeprovidersmicrosoftconsumptionusagedetails-get
      parameters:
      - in: query
        name: $expand
  ...
  /providers/Microsoft.Consumption/operations:
    get:
      ...
      description: Lists all of the available consumption REST API operations.
      operationId: Operations_List
      x-api-path-slug: providersmicrosoftconsumptionoperations-get
      parameters:
      - in: query
        name: No Name
      responses:
